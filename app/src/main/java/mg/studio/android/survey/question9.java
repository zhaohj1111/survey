...
public class question9 extends AppCompatActivity {
    ...
    public  void test10(View view){
        Intent intent10=new Intent(this,question10.class);
        intent10.putExtra("Wel",welcome);
        intent10.putExtra("Q1",q1);
        intent10.putExtra("Q2",q2);
        intent10.putExtra("Q3",q3);
        intent10.putExtra("Q4",q4);
        intent10.putExtra("Q5",q5);
        intent10.putExtra("Q6",q6);
